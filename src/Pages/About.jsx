          ...
          <div className="w-full bg-[var(--color-card-bg)]/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 md:p-12">
            <div className="flex flex-col items-center md:items-start">
              <img
                src={profileMedia}
                alt="Profile"
                className="w-32 h-32 rounded-full object-cover border-4 border-[var(--color-card-border)] shadow-lg mb-6 transform hover:scale-110 transition-transform duration-300"
              />
              <div className="flex flex-col items-center md:items-start mb-8">
                <span className="text-lg text-[var(--color-text-primary)]/70">Hey, I&apos;m</span>
            ...
            <div className="flex flex-col gap-8 w-full">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-[var(--color-text-primary)] mb-4 uppercase tracking-wider">Professional Summary</h2>
                <p className="text-lg text-[var(--color-text-primary)]/80 leading-relaxed">
              ...
              {/* Skills */}
              <div>
                <h2 className="text-2xl font-semibold text-[var(--color-text-primary)] mb-4 uppercase tracking-wider">Skills</h2>
                <ul className="text-lg text-[var(--color-text-primary)]/80 space-y-2">
              ...
              {/* Education */}
              <div>
                <h2 className="text-2xl font-semibold text-[var(--color-text-primary)] mb-4 uppercase tracking-wider">Education</h2>
                <ul className="text-lg text-[var(--color-text-primary)]/80 space-y-2">
              ...
              {/* Awards */}
              <div>
                <h2 className="text-2xl font-semibold text-[var(--color-text-primary)] mb-4 uppercase tracking-wider">Awards</h2>
                <ul className="text-lg text-[var(--color-text-primary)]/80 space-y-2">
